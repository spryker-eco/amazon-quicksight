...
namespace SprykerEco\Zed\AmazonQuicksight\Dependency\Service;

class AmazonQuicksightToUtilEncodingServiceBridge implements AmazonQuicksightToUtilEncodingServiceInterface
{
    /**
