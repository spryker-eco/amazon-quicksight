                ...
                (new QuicksightConsoleTransfer())->setInitialPath(
                    ...
                    (new FeatureConfigurationsTransfer())->setAmazonQInQuickSight(
                        (new AmazonQInQuickSightTransfer())
                            ->setDataQnA((new DataQnATransfer())->setEnabled($this->amazonQuicksightConfig->isDataQnAEnabled()))
                            ->setDataStories((new DataStoriesTransfer())->setEnabled($this->amazonQuicksightConfig->isDataStoriesEnabled()))
                            ->setExecutiveSummary((new ExecutiveSummaryTransfer())->setEnabled($this->amazonQuicksightConfig->isExecutiveSummaryEnabled()))
                            ->setGenerativeAuthoring((new GenerativeAuthoringTransfer())->setEnabled($this->amazonQuicksightConfig->isGenerativeAuthoringEnabled())),
                    ),
                ),
            ));
    }
